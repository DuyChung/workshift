    ...
    <div className="space-y-6 max-w-2xl">
      ...
      {isLoading ? (
        ...
        <div className="card p-12 text-center">
          ...
          <p className="text-gray-400 text-xs mt-1">You'll be notified when shifts are assigned or updated</p>
        </div>
      ) : (
        <div className="card divide-y divide-gray-50 overflow-hidden">
          {notifications.map(n => (
            <div
              ...
              className={`flex items-start gap-4 p-4 transition-colors cursor-pointer hover:bg-gray-50 ${!n.isRead ? 'bg-indigo-50/40' : ''}`}
            >
